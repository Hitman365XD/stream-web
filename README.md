...
* **Lectura de API twitch para credenciales**
    ...
    Aquí es ejecutar un [servicio de vídeo](https://github.com/Hitman365XD/stream-server), que envía tanto el archivo multimedia y la información del canal. Deben ser colocados en un .env, que tendrá la misma estructura de `.env.example` (VITE_VIDEO_URL recibe el `/hls/stream.m3u8` y VITE_DATA_URL el `/stream-data`).
